...
OUTBOX = ROOT / "outbox"
TELEGRAM_STATE_PATH = CHANNEL_DIR / "telegram_posted.json"
JOBS_GROWTH_PATH = CHANNEL_DIR / "jobs_growth.yaml"
JOBS_PROMOTED_PATH = CHANNEL_DIR / "jobs_promoted.json"
JOBS_SITE = "https://inpursuit.co.in"
JOBS_HUB_URL = "https://inpursuit.co.in/jobs/"
